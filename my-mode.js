ace.define(
  ...
  function(require, exports, module) {
    ...
    var tokenTypeMapping = antlr4_require('./rtype-token-type-mapping');
    ...
    var RtypeLexer = antlr4_require('./parser/RtypeLexer').RtypeLexer;
    ...
    (function() {
      ...
      this.getTokenizer = function() {
        if (!this.$tokenizer) {
          this.$tokenizer = new Antlr4Tokenizer(RtypeLexer, tokenTypeToNameMap);
        }
